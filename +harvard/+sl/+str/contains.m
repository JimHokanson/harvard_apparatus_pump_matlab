...
%Testing end match
harvard.sl.str.contains('testing','ing','location','end')

%String too long
harvard.sl.str.contains('testing','asdfasdfing','location','end')

%Testing start
harvard.sl.str.contains('testing','test','location','start')

%Middle match
harvard.sl.str.contains('testing','est','location','anywhere')
